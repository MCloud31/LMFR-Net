...
from my_dataset_stare import StareDataset
...
def main(args):
    ...
    mean = (0.719, 0.388, 0.118)
    std = (0.227, 0.128, 0.071)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.save_best is True:
            torch.save(save_file, "save_weights/B_ICB_LMAFF_STARE.pth")
        else:
            torch.save(save_file, "save_weights/B_ICB_LMAFF_STARE-{}.pth".format(epoch))
...
def parse_args():
    ...
    parser.add_argument('--lr', default=0.045, type=float, help='initial learning rate')
