...
def main():
    ...
    # img_dir = "./CHASEDB1/training/images"
    # roi_dir = "./CHASEDB1/training/mask"
    # img_dir = "./STARE/training/images"
    # roi_dir = "./STARE/training/mask"
    ...
    # Switching datasets may require changing file suffixes
