...
from my_dataset_drive import DriveDataset
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.save_best is True:
            torch.save(save_file, "save_weights/B_ICB_LMAFF_DRIVE.pth")
        else:
            torch.save(save_file, "save_weights/B_ICB_LMAFF_DRIVE-{}.pth".format(epoch))
